...
MAIL_FROM = 'vargichwork@gmail.com', // от какого email будет отправляться письмо
MAIL_FROM_NAME = 'Метиз Электрод', // от какого имени будет отправляться письмо
MAIL_SUBJECT = 'Сообщение с формы обратной связи', // тема письма
MAIL_ADDRESS = 'vargichegor@yandex.ru', // кому необходимо отправить письмо
...
MAIL_SMTP_USERNAME = 'vargichwork@gmail.com', // SMTP-пользователь
MAIL_SMTP_PASSWORD = 'EV171101'; // SMTP-пароль
